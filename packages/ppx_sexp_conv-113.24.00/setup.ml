(* OASIS_START *)
(* DO NOT EDIT (digest: 2f2f92fd509931342d40e16bfc937aee) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/ppx_sexp_conv";
          synopsis =
          ...
          sections =
            [
               Library
                 ({
                     cs_name = "ppx_sexp_conv_expander";
                   ...
                   {
                      lib_modules = ["Ppx_sexp_conv_expander"];
                      lib_pack = false;
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("ppx_core", None);
                           InternalLibrary "ppx_sexp_conv_expander";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "nGM\255\134Y]\225\161\246\229 \189d\2549";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
