(* OASIS_START *)
(* DO NOT EDIT (digest: fd008f3a5723c10a45d42f61c01b3d87) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/ppx_sexp_message";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "ppx_sexp_message";
                           FindlibPackage ("ppx_driver", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\0254\139\199\146\160\014\197\201D\213\243\2463:\250";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
