...
module M =
  struct
    ...
    let lexing_position ~fname  ~lnum  ~bol  ~cnum  =
      {
    ...
    let psig_type ~loc  x0 = { psig_loc = loc; psig_desc = (Psig_type x0) }
    ...
    let pstr_type ~loc  x0 = { pstr_loc = loc; pstr_desc = (Pstr_type x0) }
...
module Make(Loc:sig val loc : Location.t end) =
  struct
    ...
    let psig_type x0 = { psig_loc = loc; psig_desc = (Psig_type x0) }
    ...
    let pstr_primitive x0 =
      { pstr_loc = loc; pstr_desc = (Pstr_primitive x0) }
    let pstr_type x0 = { pstr_loc = loc; pstr_desc = (Pstr_type x0) }
