(* OASIS_START *)
(* DO NOT EDIT (digest: d95dd84db3ba5dcc4356969129c1bc82) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/typerep";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\174\223\142\137\164I@\185\158%\000n\174\182\146`";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
