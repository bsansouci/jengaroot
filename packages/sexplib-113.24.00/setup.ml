(* OASIS_START *)
(* DO NOT EDIT (digest: 12788f04b4f2351533cc1af0ef753114) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights =
            [
               "(C) 2005-2016 Jane Street Group LLC <opensource@janestreet.com>"
            ];
          maintainers =
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Sexplib_num_conv"; "Std"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "5\196\214\193k\210\030\030K\139\250\145\184v\215w";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
