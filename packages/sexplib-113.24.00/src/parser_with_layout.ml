...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 81 "parser_with_layout.mly"
                                                       ( With_pos.sexp_comment (List.rev _2) _3 )
# 242 "parser_with_layout.ml"
               : 'comment_abs))
; (fun __caml_parser_env ->
    Obj.repr(
# 84 "parser_with_layout.mly"
                  ( [] )
# 248 "parser_with_layout.ml"
               : 'rev_comments_abs))
; (fun __caml_parser_env ->
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 104 "parser_with_layout.mly"
                       ( _2 :: _1 )
# 319 "parser_with_layout.ml"
               : 'rev_sexps_aux))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'rev_sexps_aux) in
    Obj.repr(
# 107 "parser_with_layout.mly"
                      ( _1 )
# 326 "parser_with_layout.ml"
               : Type_with_layout.t_or_comment list))
; (fun __caml_parser_env ->
    Obj.repr(
# 108 "parser_with_layout.mly"
        ( [] )
# 332 "parser_with_layout.ml"
               : Type_with_layout.t_or_comment list))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'rev_sexps_aux) in
    Obj.repr(
# 111 "parser_with_layout.mly"
                      ( List.rev _1 )
# 339 "parser_with_layout.ml"
               : Type_with_layout.t_or_comment list))
; (fun __caml_parser_env ->
    Obj.repr(
# 112 "parser_with_layout.mly"
        ( [] )
# 345 "parser_with_layout.ml"
               : Type_with_layout.t_or_comment list))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'rev_sexps_abs) in
    Obj.repr(
# 116 "parser_with_layout.mly"
                      ( List.rev _1 )
# 352 "parser_with_layout.ml"
