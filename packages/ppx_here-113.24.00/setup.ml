(* OASIS_START *)
(* DO NOT EDIT (digest: 5b429f0c64e6f98f4c6d7f52d6bea0f3) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/ppx_here";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("ppx_core", None);
                           FindlibPackage ("ppx_driver", None);
                           InternalLibrary "ppx_here_expander"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some ";\201\221\029U\191ws\231\222\211-\026n\172^";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
