(* OASIS_START *)
(* DO NOT EDIT (digest: ca826e60425591f4e67f5b67ef54e924) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/ppx_fail";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\rR\197I\127/a\011;\235\024EE\224/_";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
