(* OASIS_START *)
(* DO NOT EDIT (digest: 6bdd1f6186d455b77244c9f0b75d71a7) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          distclean_custom =
            {
               pre_command =
                 [(OASISExpr.EBool true, Some (("$rm", ["src/config.h"])))];
               post_command = [(OASISExpr.EBool true, None)]
            };
          files_ab = ["META.ab"];
          sections =
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources =
                        ["blit_stubs.c"; "config.h"; "float_stubs.c"];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "N,\207\245\130wa\250\0286C\209~\232\002\164";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
