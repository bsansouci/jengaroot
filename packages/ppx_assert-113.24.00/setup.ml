(* OASIS_START *)
(* DO NOT EDIT (digest: bed556dc947d54fe0927a8c72374560b) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/ppx_assert";
          synopsis =
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("ppx_compare.expander", None);
                           FindlibPackage ("ppx_core", None);
                           FindlibPackage ("ppx_driver", None);
                           FindlibPackage ("ppx_here.expander", None);
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "runtime-lib";
                      bs_compiled_object = Best;
                      bs_build_depends = [FindlibPackage ("sexplib", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "L1\185<\203\147\021\161\000:u\131\243\153\180\192";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
