(* OASIS_START *)
(* DO NOT EDIT (digest: 66c615c7855d73cdf8e89a2e013edd84) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/ppx_enumerate";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "&L\2282[Qc\001\179\236\184\b\006 \177\242";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
