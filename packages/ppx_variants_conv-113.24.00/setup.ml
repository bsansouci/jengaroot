(* OASIS_START *)
(* DO NOT EDIT (digest: df65d1b71a701a01d96d673a05e98593) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/ppx_variants_conv";
          synopsis =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "o\236\192\157\134\219+\222}\213\191\141m\018F&";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
