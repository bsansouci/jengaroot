(* OASIS_START *)
(* DO NOT EDIT (digest: ee3b3fbdda0193650ee61797d8ff805b) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ppx_driver_ocamlbuild"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Library
                 ({
                     cs_name = "ppx_driver_runner_as_ppx";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Ppx_driver_runner_as_ppx"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\\|\129Q\202j\187ng\142\1932\023jvo";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
