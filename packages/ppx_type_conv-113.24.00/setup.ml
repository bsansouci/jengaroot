(* OASIS_START *)
(* DO NOT EDIT (digest: 5c753e4dc92d6c907ce7ef61de03ef52) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/ppx_type_conv";
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Ignore_unused_warning"; "Std"; "Type_conv"];
                      lib_pack = true;
               ...
               Library
                 ({
                     cs_name = "ppx_type_conv_deriving";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "ppx_deriving_exporter";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           FindlibPackage ("ppx_deriving.api", None);
                           InternalLibrary "ppx_type_conv"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      lib_modules = ["Ppx_type_conv_deriving"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\206K/\149\139G\248\153\217\202\138\137.SJ\192";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
