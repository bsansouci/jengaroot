(* OASIS_START *)
(* DO NOT EDIT (digest: 26151e6efb5075e51b0f176c815a7e5e) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/ppx_sexp_value";
          synopsis =
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "ppx_sexp_value";
                           FindlibPackage ("ppx_driver", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\127\227\214)\139\196\001\r6\0207R\135-!\159";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
