(* OASIS_START *)
(* DO NOT EDIT (digest: c1c803205f941333cf717cba722aed6b) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/ppx_bench";
          synopsis =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "n\177>/\161L3\006.\199\031\240\t\023\159\020";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
