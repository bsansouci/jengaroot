(* OASIS_START *)
(* DO NOT EDIT (digest: f6e7ff742568fbc7e409b1a5a1dff230) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Expect_test_collector"];
                      lib_pack = false;
               ...
               Library
                 ({
                     cs_name = "expect_test_evaluator_lib";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "evaluator/lib";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "expect_test_collector";
                   ...
                   {
                      lib_modules =
                        ["Evaluator"; "Expectation"; "Lexer"; "Reconcile"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("ppx_inline_test.libname", None);
                   ...
                   {
                      lib_modules = ["Expect_extension"; "Main"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\005\174\151VRK\219 \0066\133+\180_G\020";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
