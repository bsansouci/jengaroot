(* OASIS_START *)
(* DO NOT EDIT (digest: 457d145ba08262e2c01366335f04a67e) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/ppx_custom_printf";
          synopsis =
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "ppx_format_lifter";
                           FindlibPackage ("ppx_sexp_conv.expander", None);
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "ppx_custom_printf";
                           FindlibPackage ("ppx_driver", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\219\020\019\148\127\148\140\025\129Ns\134\242I\172T";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
