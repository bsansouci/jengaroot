(* OASIS_START *)
(* DO NOT EDIT (digest: 34ad77b565b030fa9e0bf33f3d239e35) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/ppx_let";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "4\195\133\174A\140F82gD\144,\148\026p";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
