...
let omake_style = Misc.getenv_bool omake_style_varname ~default:false
let ascii_diffs_varname = "UNIFIED_TESTS_ASCII_DIFFS"
let ascii_diffs = Misc.getenv_bool ascii_diffs_varname ~default:false

let rules ~dir { target; deps; setup_script } =
...
"
              ...
              (Path.reach_from ~dir unified_tests_script))))
  in
